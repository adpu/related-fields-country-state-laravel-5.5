# Example of related fields country /state in Laravel 5.5

## Steps:

1 -  Create a migration of database table called 'countries':
...
2 - Create a migration of database table called 'states':
...
3 - Create a new feed (CountriesTableSeeder.php), I only use some countries not all:
...
4 - Create a new feed (StatesTableSeeder.php), It contents all states from countries selected:
...
7 - Create Controller (CheckoutsController)
...
8 - Create view with related fields and ajax (checkout2.blade.php)
...
9 - Add this lines in /routes/web.php file:
...
Route::get('/getstate/{id}','CheckoutsController@getStates');
```
